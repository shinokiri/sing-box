...
type Group struct {
	...
	UrlTestId                int64                  `protobuf:"varint,7,opt,name=urlTestId,proto3" json:"urlTestId,omitempty"`
	UrlTestRunning           bool                   `protobuf:"varint,8,opt,name=urlTestRunning,proto3" json:"urlTestRunning,omitempty"`
	UrlTestProgressSupported bool                   `protobuf:"varint,9,opt,name=urlTestProgressSupported,proto3" json:"urlTestProgressSupported,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *Group) GetUrlTestId() int64 {
	if x != nil {
		return x.UrlTestId
	}
	return 0
...
func (x *Group) GetUrlTestRunning() bool {
	if x != nil {
		return x.UrlTestRunning
	}
	return false
}

func (x *Group) GetUrlTestProgressSupported() bool {
	if x != nil {
		return x.UrlTestProgressSupported
	}
	return false
}
...
type GroupItem struct {
	...
	UrlTestId    int64                  `protobuf:"varint,5,opt,name=urlTestId,proto3" json:"urlTestId,omitempty"`
	// 0 idle, 1 queued, 2 running, 3 succeeded, 4 failed, 5 canceled.
	UrlTestState  int32 `protobuf:"varint,6,opt,name=urlTestState,proto3" json:"urlTestState,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GroupItem) GetUrlTestId() int64 {
	if x != nil {
		return x.UrlTestId
	}
	return 0
...
func (x *GroupItem) GetUrlTestState() int32 {
	if x != nil {
		return x.UrlTestState
	}
	return 0
}
...
type URLTestRequest struct {
	...
	// Older clients retain the asynchronous acknowledgement behavior.
...
func (x *URLTestRequest) GetWait() bool {
	if x != nil {
		return x.Wait
	}
	return false
...
func (x *TailscaleEndpointStatus) GetCertDomains() []string {
	if x != nil {
...
type TailscaleCertificateRequest struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	EndpointTag        string                 `protobuf:"bytes,1,opt,name=endpointTag,proto3" json:"endpointTag,omitempty"`
	Domain             string                 `protobuf:"bytes,2,opt,name=domain,proto3" json:"domain,omitempty"`
	MinValiditySeconds int64                  `protobuf:"varint,3,opt,name=minValiditySeconds,proto3" json:"minValiditySeconds,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *TailscaleCertificateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *TailscaleCertificateRequest) GetDomain() string {
	if x != nil {
		return x.Domain
	}
	return ""
...
func (x *TailscaleCertificateRequest) GetMinValiditySeconds() int64 {
	if x != nil {
		return x.MinValiditySeconds
	}
	return 0
}

type TailscaleCertificate struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	CertificatePEM []byte                 `protobuf:"bytes,1,opt,name=certificatePEM,proto3" json:"certificatePEM,omitempty"`
	PrivateKeyPEM  []byte                 `protobuf:"bytes,2,opt,name=privateKeyPEM,proto3" json:"privateKeyPEM,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *TailscaleCertificate) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *TailscaleCertificate) GetPrivateKeyPEM() []byte {
	if x != nil {
...
const file_daemon_started_service_proto_rawDesc = "" +
	...
	"\x06Groups\x12#\n" +
	"\x05group\x18\x01 \x03(\v2\r.daemon.GroupR\x05group\"\xb0\x02\n" +
	"\x05Group\x12\x10\n" +
	...
	"\x05items\x18\x06 \x03(\v2\x11.daemon.GroupItemR\x05items\x12\x1c\n" +
	"\turlTestId\x18\a \x01(\x03R\turlTestId\x12&\n" +
	"\x0eurlTestRunning\x18\b \x01(\bR\x0eurlTestRunning\x12:\n" +
	"\x18urlTestProgressSupported\x18\t \x01(\bR\x18urlTestProgressSupported\"\xb9\x01\n" +
	"\tGroupItem\x12\x10\n" +
	"\x03tag\x18\x01 \x01(\tR\x03tag\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12 \n" +
	"\vurlTestTime\x18\x03 \x01(\x03R\vurlTestTime\x12\"\n" +
	"\furlTestDelay\x18\x04 \x01(\x05R\furlTestDelay\x12\x1c\n" +
	"\turlTestId\x18\x05 \x01(\x03R\turlTestId\x12\"\n" +
	"\furlTestState\x18\x06 \x01(\x05R\furlTestState\"F\n" +
	...
	"\vendpointTag\x18\x01 \x01(\tR\vendpointTag\"\x87\x01\n" +
	"\x1bTailscaleCertificateRequest\x12 \n" +
	"\vendpointTag\x18\x01 \x01(\tR\vendpointTag\x12\x16\n" +
	"\x06domain\x18\x02 \x01(\tR\x06domain\x12.\n" +
	"\x12minValiditySeconds\x18\x03 \x01(\x03R\x12minValiditySeconds\"d\n" +
	"\x14TailscaleCertificate\x12&\n" +
	"\x0ecertificatePEM\x18\x01 \x01(\fR\x0ecertificatePEM\x12$\n" +
	"\rprivateKeyPEM\x18\x02 \x01(\fR\rprivateKeyPEM\"\xc2\x01\n" +
	...
	"\x0fTailscaleLogout\x12\x1e.daemon.TailscaleLogoutRequest\x1a\x16.google.protobuf.Empty\"\x00\x12^\n" +
	"\x17GetTailscaleCertificate\x12#.daemon.TailscaleCertificateRequest\x1a\x1c.daemon.TailscaleCertificate\"\x00\x12f\n" +
...
var file_daemon_started_service_proto_msgTypes = make([]protoimpl.MessageInfo, 104)
